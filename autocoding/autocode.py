...
dataFormat_template_h = "dataFormat.template.h"
dataFormat_h_output = "../applications/dataFormat.h"
# create new AutoGeneratedFile object
dataFormat_h = AutoGeneratedFile(dataFormat_template_h, dataFormat_h_output, "sc1-data-format/format.json")
# pass in the placeholder text and the auto generation method
dataFormat_h.autocode(default_placeholder, generators.dataFormat_h_generator)

dataFormat_template_cpp = "dataFormat.template.cpp"
dataFormat_cpp_output = "../applications/dataFormat.cpp"
dataFormat_cpp = AutoGeneratedFile(dataFormat_template_cpp, dataFormat_cpp_output, "sc1-data-format/format.json")
dataFormat_cpp.autocode(default_placeholder, generators.dataFormat_cpp_generator)

# generate sofi interface struct files (to receive data from software)
sofi_template_h = "sofi.template.h"
sofi_h_output = "../applications/sofi.h"
sofi_h = AutoGeneratedFile(sofi_template_h, sofi_h_output, "SoFi-interface/interface.json")
sofi_h.autocode(default_placeholder, generators.sofi_h_generator)

sofi_template_cpp = "sofi.template.cpp"
sofi_cpp_output = "../applications/sofi.cpp"
sofi_cpp = AutoGeneratedFile(sofi_template_cpp, sofi_cpp_output, "SoFi-interface/interface.json")
sofi_cpp.autocode(default_placeholder, generators.sofi_cpp_generator)
